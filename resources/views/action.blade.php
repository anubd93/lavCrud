	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				{!! Form::model($members, [ 'method' => 'post','route' => ['member.update', $member->id] ]) !!}
			    {{--{{csrf_token()}}--}}
				<div class="form-group">
						<div class="row">
				    		<div class="col-md-2" style="margin-top:7px;">
				    			{!! Form::label('new_tbl_name', 'New Table Name') !!}
				    		</div>
				    		<div class="col-md-10">
				    			{!! Form::text('tbl_name', $member->tbl_name, ['class' => 'form-control']) !!}
				    		</div>
				    	</div>
			    	</div>
			    	{{--<div class="form-group">--}}
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				{!! Form::model($members, [ 'method' => 'delete','route' => ['member.delete', $member->id] ]) !!}
					...
					<h5 class="text-center">Name: {{$member->tbl_name}}</h5>
			</div>
			<div class="modal-footer">
				<button type="button" class="btn btn-default" data-dismiss="modal"><i class="fa fa-times"></i> Cancel</button>
